...
def show_static_insight(title, insights):
    st.markdown(f"🧠 **AI Insight – {title}:**")
...
if uploaded_file:
    ...
    insights2 = [
        f"Pada tanggal {top_day['Date'].date()}, engagement mencapai puncaknya dengan total {top_day['Engagements']} interaksi. Ini menunjukkan adanya momentum atau konten yang sangat menarik di hari tersebut.",
