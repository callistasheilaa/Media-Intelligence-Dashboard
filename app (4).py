...
if uploaded_file:
    ...
    if api_key:
        prompt3 = f"Buat insight dari engagement tiap platform berikut:\n{plat.to_string(index=False)}"
        st.markdown("💡 **AI Insight:**")
    ...
    if api_key:
        prompt4 = f"Apa insight yang bisa ditarik dari distribusi jenis media berikut:\n{media.to_string(index=False)}"
        st.markdown("💡 **AI Insight:**")
    ...
    if api_key:
        prompt5 = f"Apa insight dari 5 lokasi dengan engagement tertinggi berikut:\n{top5.to_string(index=False)}"
        st.markdown("💡 **AI Insight:**")
